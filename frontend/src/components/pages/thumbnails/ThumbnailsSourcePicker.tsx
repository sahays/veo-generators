...
export const ThumbnailsSourcePicker = ({
  sourceTab,
  setSourceTab,
  productions,
  uploads,
  ...
  <Card className="overflow-visible">
    ...
    <div className="px-5 pb-5">
      {loading ? (
        ...
        <ProductionsList productions={productions} onSelect={onSelectProduction} />
      ) : (
        <UploadsList
          uploads={uploads}
          onSelect={onSelectUpload}
          onNavigateUploads={onNavigateUploads}
        />
      )}
    </div>
  </Card>
...
const ProductionsList = ({
  ...
  productions: CompletedProductionSource[]
  onSelect: (prod: CompletedProductionSource) => void
}) => {
